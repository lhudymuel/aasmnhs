...
?>
<?php
  $sql ="SELECT * FROM `tblinstructor` WHERE INST_ID  ";
...
?>
<?php
  $sql ="SELECT * FROM `subject` WHERE SUBJ_ID  ";
   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/logonbg.png" height="23">
                Anselmo A. Sandoval Memorial National High School</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right" > 
                 <li class="dropdown" >
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo web_root; ?>admin/track/index.php?view=add"><i class="fa  fa-building  fa-fw"></i> Track</a>
                        </li>
                        <li><a href="<?php echo web_root; ?>admin/strand/index.php?view=add"><i class="fa  fa-graduation-cap fa-fw"></i> Strand</a>
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Hi, <?php echo $_SESSION['ACCOUNT_NAME']; ?> <img title="profile image" width="40px" height="40px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                          ...
                          <div class="divpic"> 
                            <a href="" data-target="#usermodal"  data-toggle="modal" > 
                                <img title="profile image" width="60" height="60" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                            </a>
                          </div> 
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             ...
                             <label class="label pull-right label-primary"><?php echo $tottr ; ?></label> </a>
                  </li>
                           
                         <li>
                             <a href="<?php echo web_root; ?>admin/strand/index.php" ><i class="fa  fa-graduation-cap fa-fw"></i>  Strand  
                             <label class="label pull-right label-primary"><?php echo $tots ; ?></label> </a>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/student/index.php" ><i class="fa fa-group fa-fw"></i>  Students 
                             <label class="label pull-right label-primary"><?php echo $tot ; ?></label> </a>
                          
            
                        </li>
                        
                        <li>
                             <a href="<?php echo web_root; ?>admin/instructor/index.php" ><i class="fa fa-group fa-fw"></i>Instructor 
                             <label class="label pull-right label-primary"><?php echo $totst ; ?></label></a>
                        ...
                        ?>
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa fa-user fa-fw"></i> Admin User </a>
  ...
  <div id="page-wrapper">
            ...
            <div class="row" >
                ...
                <div class="col-lg-12"> 
                    ...
                    <?php 
                    if ($title<>'Home'){
                       echo   ' <a style="color: black;" href="'. web_root.'admin/index.php" title="Home" >Home</a>  / 
                        <a style="color: black;" href="index.php" title="'. $title.'" >'. $title.'</a> 
